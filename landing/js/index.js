const langs = {
    rus: {
        ...
        fomoText: "Один билет = 100 MRT. Вы выигрываете раунд, если после Вас никто не купил билет в течение 15 минут. В конце раунда выигрывает последний купленный билет. Раунд длится один день, последний раунд - 4 февраля",
    ...
    eng: {
        ...
        fomoText: 'Each ticket costs 100 MRT. Each round lasts one day, and the winner is the last to buy a ticket. You can also win the round if no one has bought a ticket 15 minutes after your purchase. The final round will be held on February 4',
        lotterySubtitle: 'Two lotteries will be held on 13 December and 13 January. Ticket costs 100 MRT, on each of these days the following prizes will be drawn:',
