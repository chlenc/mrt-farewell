const langs = {
    rus: {
        ...
        fomoText: "Вы выигрываете раунд, если после Вас никто не купил билет в течение 15 минут. В конце раунда выигрывает последний купленный билет. Раунд длится один день, последний раунд - 13 января",
        lotterySubtitle: "Два розыгрыша пройдут 13 декабря и 13 января. В каждый из этих дней будут разыграны следующие суммы: ",
        littleRhombusTextChunk1: "Выбрерите как участвовать",
        littleRhombusTextChunk2: "Каждый билет стоит 100 MRT ",
    ...
    eng: {
        ...
        fomoText: 'You win a round if no one has bought a ticket within 15 minutes after you. At the end of the round, the last ticket bought wins. The round lasts one day, the last round is January 13th',
        lotterySubtitle: 'Two lotteries will be held on 13 December and 13 January. The following amounts will be drawn in each lottery',
        littleRhombusTextChunk1: 'Choose how to participate',
        littleRhombusTextChunk2: 'Each ticket costs 100 MRT',
